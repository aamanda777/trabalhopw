...
<body class="bg-yellow-50">
    <div class="container mx-auto px-4 py-10">
                ...
                ?>
                    ...
                    <div class="bg-gray-50 rounded-lg shadow-md p-4 ">
                        ...
                        <a href="download.php?id=<?php echo $documentoId; ?>"
                            class="inline-block bg-green-300 hover:bg-green-400 focus:bg-green-600 transition-colors duration-300 ease-in-out text-white font-semibold px-5 py-2 rounded-lg mr-2 mt-3">
                            <i class="fa regular fa-sharp fa-solid fa-download" style="color: #1a6100;"></i>
                        </a>
                        <form method="POST" action="excluir_meusdocumentos.php" class="inline-block">
                            ...
                            <button type="submit"
                                class="bg-red-300 hover:bg-red-400 focus:bg-red-400 transition-colors duration-300 ease-in-out text-white font-semibold px-4 py-2 rounded-lg">
                                <i class="fa regular fa-sharp fa-solid fa-trash" style="color: #f00000;"></i></button>
                        </form>
                    </div>
        ...
        <?php } else {
            echo '<p class="uppercase text-red-700 m-4 text-center">Nenhum documento encontrado.</p>';
        }
        ...
        <p class="text-gray-700 text-center">Voltar para a <a href="index.php" class="text-pink-500 font-bold hover:underline">tela inicial</a>.</p>
    </div>
</body>
